	...
	<header>
		<div class="container">
			...
			<nav class="right">
				...
				<ul>
					<li>
						<a target="_self" href="<?=base_url('empresa'); ?>" class="first"><?=lang('defualt_menu_empresa'); ?></a>
					</li>
					<li>
						<a target="_self" href="<?=base_url('guaiba-2'); ?>" class="first"><?=lang('defualt_menu_guaiba2'); ?></a>
					</li>
					<li>
						<a target="_self" href="<?=base_url('produtos'); ?>" class="first"><?=lang('defualt_menu_produtos'); ?></a>
					</li>
					<li>
						<a target="_self" href="<?=base_url('responsabilidade'); ?>" class="first"><?=lang('defualt_menu_responsabilidade'); ?></a>
					</li>
					<?php if(getLang() == 'brazilian'){ ?>
						...
						<?php } ?>
						<li>
							<a target="_self" href="<?=base_url('contato'); ?>" class="first"><?=lang('defualt_menu_contato'); ?></a>
						</li>
