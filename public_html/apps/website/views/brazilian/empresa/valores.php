<section id="valores">
	<div class="container">
		<div class="col-md-offset-1 col-md-10">
			...
			<h3>Missão</h3>
			<p>Ofertar produtos obtidos de forma sustentável a partir de florestas plantadas, gerando benefícios econômicos, sociais e ambientais, contribuindo, desta forma, para o bem-estar e qualidade de vida das pessoas.</p>

			<h3>Visão</h3>
			<p> Ser reconhecida como produtora mundial de celulose e papel, pela excelência na operação de seus processos e pelo respeito às suas partes interessadas. </p>

			<h3>Política do Sistema de Gestão</h3>
			<p>
				A CMPC Celulose Riograndense, fornecedora no mercado mundial de celulose branqueada de eucalipto e de papel para impressão e escrita, considera que a qualidade de seus produtos e serviços prestados, providos por meio da operação e gestão sustentável de seu negócio, são fundamentais para assegurar retorno aos acionistas a partir de:</p>
