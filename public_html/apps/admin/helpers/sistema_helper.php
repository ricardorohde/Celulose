...
function getLang($i = 0){
	$lang = array(1 => 'Brazilian', 2 => 'English');
...
function parseFiltros($string){
	...
	$string = str_replace(array_keys($filtros),$filtros,$string);
...
function time_ago($tm) {
	...
	return str_replace('mêss','meses',$x);
}
/* strtourl */
