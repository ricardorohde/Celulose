...
<div class="content-header">
	<div class="content-header-title">Obras - Fotos Upload</div>
...
<div class="content-forms">
	<form action="<?=current_url(); ?>" method="post" id="form_main" enctype="multipart/form-data">
		<div class="row">
			<div class="span2">Foto: (1024x683px) .jpg</div>
			<div class="span10">
		...
		<div class="row">
			...
			<div class="span10">
				<input type="text" name="descricao" value="" maxlength="160" class="span10">
			</div>
		</div>
		<div class="row">
