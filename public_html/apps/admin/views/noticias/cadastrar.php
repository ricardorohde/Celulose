...
<div class="content-header">
	<div class="content-header-title">Notícias - Cadastrar</div>
...
<div class="content-forms">
	<form action="<?=current_url(); ?>" method="post" id="form_main">
		<div class="row">
			...
			<div class="span10">
				<input type="text" name="form_titulo" value="" maxlength="160" class="span10 validate[required]">
			</div>
		</div>
		<div class="row">
			...
			<div class="span3">
				<label class="radio inline">
					<input type="radio" value="1" checked="checked" name="form_visible"> Visível
				</label>
				<label class="radio inline">
					<input type="radio" value="0" name="form_visible"> Não Visível
				</label>
			</div>
