...
<div class="content-header">
	<div class="content-header-title">URLs - Cadastrar</div>
		...
		<fieldset>
			<table>
				<tr>
					...
					<td><input type="text" name="form_param" value="" maxlength="60" class="span10 validate[required]"></td>
				</tr>
				<tr>
					<td>URL: *</td>
					<td>
						<input type="text" name="form_url" value="" maxlength="200" class="span10 validate[required]">
					</td>
				</tr>
				<tr>
					<td colspan="2">
