...
<div class="content-header">
	<div class="content-header-title">Empregos - Remover - <?=$emprego->municipio; ?></div>
...
<form action="<?=current_url(); ?>" method="post">
	<div class="modal content-remove">
		...
		<div class="modal-body">
			<p>Você realmente gostaria de remover este município?</p>
		</div>
	...
	<input type="hidden" name="id" value="<?=$emprego->id; ?>">
</form>
