...
function CheckAuthentication(){
	session_start();
	if(isset($_SESSION['celulose_website']) && !empty($_SESSION['celulose_website'])){
		return true;
	}
	return false;
}
...
$config['LicenseName'] = 'celuloseriograndense.com.br';
$config['LicenseKey'] = 'CAX5-N1W6-3NBQ-7DAH-9ECC-QJCX-4RRU';

//$config['LicenseKey'] = 'RAX5-NNT8-8QFE-UW3H-KETD-GXCX-A1WJ';
...
*/
$baseUrl = 'http://www.celuloseriograndense.com.br/assets/arquivos/';
